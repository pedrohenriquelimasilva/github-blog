    ...
    <ProfileContain>
      ...
      <section>
        <ProfileHead>
          ...
          <nav>
            <a href={dataGithub.html_url} target="_blank">Github<ArrowSquareOut size={15} weight="bold"/></a>
          </nav>
        </ProfileHead>
        <ProfileContent>
          <p>{dataGithub.bio}</p>
          ...
          <div>
            <span><img src={logoGithubImage} alt='' color='#3A536B'/> {dataGithub.login}</span>
            <span><Buildings size={20} weight='fill' color='#3A536B'/> {dataGithub.company}</span>
            <span><Users size={20} weight='fill' color='#3A536B'/> {dataGithub.followers} seguidores</span>
          </div>
        </ProfileContent>
      </section>
    </ProfileContain>
